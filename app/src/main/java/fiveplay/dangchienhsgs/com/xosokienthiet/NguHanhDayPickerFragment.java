 ...
 */
public class NguHanhDayPickerFragment extends Fragment implements Button.OnClickListener {

    private final String TAG = "Ngu Hanh Day Picker Fragment";
    ...
    public void onClick(View view) {
        ...
        PreferencesHandler.saveValueToPreferences(Common.KEY_NGU_HANH_DAY, String.valueOf(day), getActivity());
        PreferencesHandler.saveValueToPreferences(Common.KEY_NGU_HANH_MONTH, String.valueOf(month), getActivity());
        PreferencesHandler.saveValueToPreferences(Common.KEY_NGU_HANH_YEAR, String.valueOf(year), getActivity());
